...
public $rsa;
	...
	function connect_db() 
	{
		$this->con = mysql_connect(HOST,constant("USERNAME"),constant("PASSWORD")) or  die("Failed Connecting To Mysql");
		mysql_select_db(constant("DATABASENAME")) or Die("Failed Connecting To Database");	
		return $this->con;
	}
